...
const ConnectToNetwork = (props) =>{
    ...
    const bandList = [
      {key:'2.4 GHz', value:WifiBands['2.4 GHz']},
      {key:'5 GHz', value:WifiBands['5 GHz']},
      {key:'6 GHz', value:WifiBands['6 GHz']},
      {key:'60 GHz', value:WifiBands['60 GHz']}
  ]
    ...
    <TextInput secureTextEntry={true} onChangeText={(text)=>{
      WifiPassword=text;
    }} style={{borderBottomColor:"#21211",borderBottomWidth:2}} placeholder="Password"></TextInput>
