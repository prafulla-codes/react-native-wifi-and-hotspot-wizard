...
import {WifiBands} from './common/WifiBands';
...
class WifiWizard {
    ...
    static connectToNetwork = async (network,SSID,password,band,isLocalOnlyNetwork = false) =>{
       let message = await RNWifiAndHotspotWizard.connectToNetwork(JSON.stringify(network),SSID,password,band,isLocalOnlyNetwork);
